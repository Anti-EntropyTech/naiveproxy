...
#pragma redefine_extname SSL_set_reality_client_auth BORINGSSL_ADD_USER_LABEL_AND_PREFIX(SSL_set_reality_client_auth)
#pragma redefine_extname SSL_get0_reality_auth_key BORINGSSL_ADD_USER_LABEL_AND_PREFIX(SSL_get0_reality_auth_key)
...
#define SSL_set_reality_client_auth BORINGSSL_ADD_PREFIX(SSL_set_reality_client_auth)
#define SSL_get0_reality_auth_key BORINGSSL_ADD_PREFIX(SSL_get0_reality_auth_key)
